            ...
            <form class="navbar-nav ms-auto">
              ...
              <!-- <div class="dropdown">
                <button class="btn bg-transparent dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                  <p class="user">Hello, <?php//htmlspecialchars($user["fname"])?></p>
                </button>
   ...
   <section class="h-100" style="background-color: #eee;">
       ...
       if(isset($_SESSION["success"])){
          ...
          if(isset($_SESSION["error"])){
            //if ((empty($_POST['email']) || empty($_POST['password'])) && isset($_SESSION["status"]) ) {
              ?>
             ...
             <div class="row g-0">
               ...
               <div class="col-xl-6">
                 <div class="card-body p-md-5 text-black" style="border-radius:40px;">
                   <h3 class="text-center h1 fw-bold mb-3 mx-1 mx-md-4 mt-2">Login</h3>
                  ...
                  <div class="text-center">
                    <p class="mt-5">Don't have an account? <a href="signup.php">Register here</a></p>
                    <p class="mt-1">Are you an Admin? <a href="admin/login-admin.php">Click here</a></p>
                  </div>
