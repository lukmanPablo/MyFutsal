    ...
    //   isset($_POST['end_time']) && isset($_POST['payment_method'])){
        ...
        elseif (empty($_POST["payment_method"])) {
          ...
          if ( $row !== false ) {
            ...
            $stmt = $pdo->prepare('INSERT INTO booking(court_id, booking_date, start_time, end_time, payment_method, user_id, price) VALUES ( :ci, :bd, :st, :et, :pm, :ui, :p)');
            $stmt->execute(array(':ci' => htmlentities($_POST['court']),
                                 ':bd' => htmlentities($_POST['booking_date']),
                                 ':st' => htmlentities($_POST['start_time']),
                                 ':et' => htmlentities($_POST['end_time']),
                                 ':pm' => htmlentities($_POST['payment_method']),
                                 ':ui' => htmlentities($_SESSION['user_id']),
                                 ':p' => htmlentities($price)));
                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                  ...
                  <div class="card" style="border-radius: 50px;">
                    <div class="card-body p-5 text-center">
                      <div class="my-md-2">
                        <h2 class="fw-bold mb-3"><u>Court Booking</u></h2>
                        ...
                        <div class="row">
                          <div class="col-xl-12">
                              <input type="date" value="<?php echo $today; ?>" class="form-control" id="booking_date" name="booking_date">
                          </div>
                        </div> <!--Select Date -->
                        ...
                        <div class="row">
                          <div class="col-xl-6">
                            <div class="cs-form">
                              <input type="time" class="form-control" name="start_time" step="900" />
                            </div>
                        </div>
                        <div class="col-xl-6">
                          <div class="cs-form">
                            <input type="time" class="form-control" name="end_time" step="900"  />
                          </div>
                        </div>
                      </div> <!--End Time -->
                      ...
                      <div class="row mt-3"> <!--Select Payment method -->
                        ...
                        <div class="row">
                          <div class="col-6">
                            ...
                            <label class="btn btn-success px-5" for="option1">
                          ...
                          <div class="col-6">
                            ...
                            <label class="btn btn-success px-5" for="option2">
                        ...
                        <div class="row mt-5">
                          <input type="submit" class="btn btn-primary text-black" name="book" value="Book Now">
                        </div>
                      </div>
                    </div>
                  </div>
